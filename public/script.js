...
// Upload song file with restraint on file-type
function uploadSong() {
    ...
    fetch('/api/upload', {  // Update with your backend URL if necessary
        method: 'POST',
        body: formData
    })
...
function renameSong(oldName, url) {
    ...
    fetch('/api/rename', {  // Update with your backend URL if necessary
        method: 'POST',
        headers: {
